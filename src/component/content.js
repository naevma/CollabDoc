...
export default class Content extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      </MuiThemeProvider> : <Draft socket = {this.props.socket} redirect = {this.redirect} title={this.state.data.title} contentHistory = {this.state.data.contentHistory} id = {this.state.data.id} saveDates = {this.state.data.savedDates}/>}
    </div>
    );
  }
}
